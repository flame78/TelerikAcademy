...
// Input:
/*
AddEvent 1/1/0001 12:00:00 AM|Title|Location
AddEvent 1/1/0001 12:00:00 AM|Title2|Location2
ListEvents 1/1/0001 12:00:00 AM|2
E
*/
...
public class Program
{
    ...
    private class EventHolder
    {
        private MultiDictionary<string, Event>
            eventByTitle = new MultiDictionary<string, Event>(true);

        private OrderedBag<Event>
            eventByDate = new OrderedBag<Event>();
        ...
        public void ListEvents(DateTime date, int count)
        {
            OrderedBag<Event>.View
                eventsToShow = this.eventByDate.RangeFrom(new Event(date, string.Empty, string.Empty), true);
